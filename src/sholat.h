...
class PrayerTimes {
  public:
    ...
    void get_prayer_times_tomorrow(time_t date, double latitude, double longitude, double timezone, double timesTomorrow[]);
    ...
    time_t timestampSholatTimesYesterday[TimesCount];
    time_t timestampSholatTimesToday[TimesCount];
    time_t timestampSholatTimesTomorrow[TimesCount];
    time_t timestampPreviousSholatTime;
    time_t timestampCurrentSholatTime;
    time_t timestampNextSholatTime;
